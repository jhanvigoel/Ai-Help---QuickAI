...
const Community = () => {
  ...
  return (
    <div className="flex-1 h-full flex flex-col gap-4 p-6">
      <h1 className="text-xl font-semibold text-gray-800 mb-4">Community Creations</h1>

      <div className="bg-white h-full w-full rounded-xl p-4 flex flex-wrap gap-4 overflow-y-auto">
        {creations.length > 0 ? (
          ...
          <p className="text-gray-500 text-center w-full">No creations found.</p>
        )}
      </div>
    </div>
  )
